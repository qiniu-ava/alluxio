...
public final class DefaultBlockMaster extends AbstractMaster implements BlockMaster {
  ...
  public void workerRegister(long workerId, List<String> storageTiers,
    ...
    synchronized (worker) {
      ...
      LOG.info("registerWorker(): id:{}, adr:{}, role:{}, cap:{}, avail:{}, total_tier:{}, free_tier:{}, blocks:{}, to_remove:{}", 
        worker.getId(), worker.getWorkerAddress(), worker.getWorkerAddress().getRole(), worker.getCapacityBytes(), 
